...
public class Bills23 extends Fragment {
            ...
            public void onClick(View v) {
                ...
                ok.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Call<orderBean> call = cr.getOrders33(SharePreferenceUtils.getInstance().getString("id") , strDate);
    ...
    public void onResume() {
        ...
        Call<orderBean> call = cr.getOrders33(SharePreferenceUtils.getInstance().getString("id") , formattedDate);
