...
public class Bills13 extends Fragment {
            ...
            public void onClick(View v) {
                ...
                ok.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Call<orderBean> call = cr.getOrders13(SharePreferenceUtils.getInstance().getString("id") , strDate);
    ...
    public void onResume() {
        ...
        Call<orderBean> call = cr.getOrders13(SharePreferenceUtils.getInstance().getString("id") , formattedDate);
                        ...
                        public void onClick(View v) {
                            ...
                            call.enqueue(new Callback<orderBean>() {
                                ...
                                public void onResponse(Call<orderBean> call, Response<orderBean> response) {
                                    ...
                                    Call<orderBean> call2 = cr.getOrders13(SharePreferenceUtils.getInstance().getString("id") , dd);
